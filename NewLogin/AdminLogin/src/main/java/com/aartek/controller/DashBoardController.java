...
public class DashBoardController {
	...
	public String showDashBoard(Map<String, Object> map, ModelMap model, HttpSession session,HttpServletRequest request) {
		map.put("Product", new ProductDto());
		  session=request.getSession(false); 
		  System.out.println("===== Session is ===== "+session);
		  Object name=(Object)session.getAttribute("login");
	        if(name!=null){ 
	        	System.out.println("====== in if session is not null ======");
	          
	        System.out.println("===== login atribute=====   "+name);
